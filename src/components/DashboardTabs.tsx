...
interface DashboardTabsProps {
  ...
  setActiveTab: (tab: "progress" | "card" | "offers") => void;
  userRole: string;
}
  ...
  <div className="w-full flex justify-center mt-6">
    <div className="flex w-full max-w-md">
      {userRole === "customer" ? (
        <>
          <button
            className={`w-1/3 px-4 py-5 font-semibold text-sm transition-all duration-200 focus:outline-none border-b-2 border-r-0 border-l-0 border-t-0 rounded-none ${
              activeTab === "progress"
