...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      try {
        register(name.trim(), email.trim(), feedback.trim() || undefined);
        toast({
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-red-950 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="p-6 flex items-center">
          ...
          <h1 className="ml-4 text-2xl font-bold text-white">Join Vape Master</h1>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="feedback" className="text-white font-medium">
                  Feedback <span className="text-gray-500 text-sm">(Optional)</span>
                </Label>
                <Textarea
                  id="feedback"
                  value={feedback}
